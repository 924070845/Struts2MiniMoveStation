				...
				<div class="col-md-12">
					<div class="box box-primary">
						...
						<s:iterator value="#session.movieList" var="mov" status="st">
							<%--有上传内容的表单必须加下面那句话--%>
							<form role="form" action="updateMovieAction" method="post" enctype="multipart/form-data">
								<div class="box-body">
									<div class="form-group">
										<label for="input_title">片名</label>
										<input type="text" class="form-control" name="title" id="input_title"
											   placeholder="请输入片名！" value="<s:property value="title"/>" readonly>
									...
									<div class="form-group">
										...
										<textarea class="form-control" name="info" rows="10" id="input_info"><s:property
												value="info"/></textarea>
									...
									<div class="form-group">
										...
										<div class="con4">
											...
											<canvas value="<s:property value="logo"/>" id="cvs" width="200" height="285"
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="area" id="input_area"
											   placeholder="请输入地区！" value="<s:property value="area"/>">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="playTime" id="input_length"
											   placeholder="请输入片长！" value="<s:property value="playTime"/>">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="releaseDate"
											   ...
											   placeholder="请选择上映时间！" value="<s:property value="releaseDate"/>">
									</div>
								</div>
