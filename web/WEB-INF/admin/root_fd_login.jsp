...
<div class="login-box">
	<div class="login-logo">
		<a href=""><b id="titles" >简&nbsp;▪&nbsp;影&nbsp;后台管理系统</b></a>
	</div>
	<div class="login-box-body" >
		...
		<form action="rootAction" method="post" id="form-data">
			<div class="form-group has-feedback">
				<input name="rootName" type="text" class="form-control" placeholder="请输入账号！" value="">
