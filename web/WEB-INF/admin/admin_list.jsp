					...
					<div class="box box-primary">
						...
						<div class="box-body table-responsive no-padding">
							<table class="table table-hover">
								...
								<tr>
									<s:iterator value="#session.adminList" var="admi" status="st">
										<%--根据当前迭代的元素的索引是否为偶数来决定是否使用背景色，其中status起关键作用--%>
								<tr <s:if test="#st.even">style="background-color: #d2d6de"</s:if>>
									<td><s:property value="#admi.adminID"/></td>
									<td><s:property value="#admi.adminName"/></td>
									<td><s:property value="#admi.addtime"/></td>
									<td style="text-align: center">
										<a href="delete_AdminAction?id=<s:property value="#admi.adminID"/>" class="label label-danger"> 删除</a>&emsp;&emsp;
									</td>
								</tr>
								</s:iterator>
								</tr>
